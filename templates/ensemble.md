...
- **Key Decisions**: List of major technical decisions and their rationale.
- **Final Architecture/Spec**: The consolidated plan or code structure.
- **Implementation Steps**: A step-by-step guide to execute the plan.
